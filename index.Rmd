...
B19058.rate = divide.acs(numerator=B19058[,2],denominator=B19058[,1], method = "proportion")
...
B23006.rate = divide.acs(numerator=(B23006[,16]+B23006[,23]),denominator=B23006[,1], method = "proportion")
...
B17017.rate = divide.acs(numerator=B17017[,2], denominator=B17017[,1], method = "proportion")
...
B23025.rate = divide.acs(numerator=B23025[,5],denominator=B23025[,2], method = "proportion")
...
B25008.rate = divide.acs(numerator=B25008[,2],denominator=B25008[,1], method = "proportion")
...
B08013.rate = divide.acs(numerator=B08013[,1],denominator=B99084[,2], method = "proportion")
...
B25002.rate = divide.acs(numerator=B25002[,3],denominator=B25002[,1], method = "proportion")
