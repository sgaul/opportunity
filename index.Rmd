...
sumtmp <- variables
colnames(sumtmp)[3:13] <- vnames

print(xtable(summary(sumtmp[3:9])), type = "html", include.rownames = F, size = "small")
print(xtable(summary(sumtmp[10:13])), type = "html", include.rownames = F, size = "small")
```
...
```{r echo = FALSE, warning = FALSE, message = FALSE, results = 'asis'}
sumtmp2 <- oppdata
colnames(sumtmp2)[3:13] <- vnames

print(xtable(round(cor(sumtmp2[3:13], use = "na.or.complete"),2)), type = "html", size = "small")
```
